...
export default function page() {
  ...
  const titleListe = [
    {
      titre: t("embeddedBrokerage.section1.BLOCK.0.title"),
      legend: t("embeddedBrokerage.section1.BLOCK.0.legend"),
      content: t("embeddedBrokerage.section1.BLOCK.0.content"),
    },
    {
      titre: t("embeddedBrokerage.section1.BLOCK.1.title"),
      legend: t("embeddedBrokerage.section1.BLOCK.1.legend"),
      content: t("embeddedBrokerage.section1.BLOCK.1.content"),
    },
    {
      titre: t("embeddedBrokerage.section1.BLOCK.2.title"),
      legend: t("embeddedBrokerage.section1.BLOCK.2.legend"),
      content: t("embeddedBrokerage.section1.BLOCK.2.content"),
    },
    {
      titre: t("embeddedBrokerage.section1.BLOCK.3.title"),
      legend: t("embeddedBrokerage.section1.BLOCK.3.legend"),
      content: t("embeddedBrokerage.section1.BLOCK.3.content"),
    },
  ];
  ...
  const threeDouble: threeDoubleType[] = [
    {
      title: t("embeddedBrokerage.section3.block.0.title"),
      smallTitle: t("embeddedBrokerage.section3.block.0.smallTitle"),
      liste: {
        0: t("embeddedBrokerage.section3.block.0.liste.1"),
        1: t("embeddedBrokerage.section3.block.0.liste.2"),
        2: t("embeddedBrokerage.section3.block.0.liste.3"),
      },
    },
    {
      title: t("embeddedBrokerage.section3.block.1.title"),
      smallTitle: t("embeddedBrokerage.section3.block.1.smallTitle"),
      liste: {
        0: t("embeddedBrokerage.section3.block.1.liste.1"),
        1: t("embeddedBrokerage.section3.block.1.liste.2"),
        2: t("embeddedBrokerage.section3.block.1.liste.3"),
      },
    },
    {
      title: t("embeddedBrokerage.section3.block.2.title"),
      smallTitle: t("embeddedBrokerage.section3.block.2.smallTitle"),
      liste: {
        0: t("embeddedBrokerage.section3.block.2.liste.1"),
        1: t("embeddedBrokerage.section3.block.2.liste.2"),
        2: t("embeddedBrokerage.section3.block.2.liste.3"),
      },
    },
  ];
  ...
  const flexWrapBlock = [
      {
        icone: "/user.svg",
        title: t("embeddedBrokerage.flexWrap.block.0.title"),
        content: t("embeddedBrokerage.flexWrap.block.0.content"),
      },
      {
        icone: "/dashboard.svg",
        title: t("embeddedBrokerage.flexWrap.block.1.title"),
        content: t("embeddedBrokerage.flexWrap.block.1.content"),
      },
      {
        icone: "/balise.svg",
        title: t("embeddedBrokerage.flexWrap.block.2.title"),
        content: t("embeddedBrokerage.flexWrap.block.2.content"),
      },
      {
        icone: "/bank-checkmark.svg",
        title: t("embeddedBrokerage.flexWrap.block.3.title"),
        content: t("embeddedBrokerage.flexWrap.block.3.content"),
      },
  ];
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <section className="mt-50 mb-15 px-4 lg:px-0">
        <Entete
          SPAN={t("embeddedBrokerage.section1.SPAN")}
          BG="bg-[#eff2ff]"
          TEXT="text-[#3a5af9]"
          H3={t("embeddedBrokerage.section1.H3")}
          P={t("embeddedBrokerage.section1.P")}
        />
      ...
      <section className="w-full my-15">
        <section className="flex flex-col min-h-screen bg-black px-8 justify-center">
          <ProgressiveTimeline
            span={t("embeddedBrokerage.section2.span")}
            title={t("embeddedBrokerage.section2.title")}
      ...
      <section className="w-full my-15 px-4 lg:px-0">
        <Entete
          SPAN={t("embeddedBrokerage.section3.span")}
          P={t("embeddedBrokerage.section3.p")}
          H3={t("embeddedBrokerage.section3.h3")}
          BG="bg-[#eff2ff]"
          TEXT="text-[#3a5af9]"
        />
        <div className="flex flex-col lg:flex-row items-center px-4 lg:px-0 w-full gap-8">
      ...
      <section className="w-full my-15">
        <div className="flex flex-col lg:flex-row w-full h-full lg:pb-10 grille lg:pr20 min-h-screen *:w-full lg:*:w-1/2 bg-black gap-30 pt-25">
          <div className="lg:pl-5 text-gray-400 px-20 lg:px-0">
            <span className="bg-[#171c30] text-[#3a5af9] px-4 text-[14px] py-2 rounded-2xl">{t("embeddedBrokerage.section4.span")}</span>
            <h3 className="text-white mb-15 mt-6 text-3xl">{t("embeddedBrokerage.section4.h3")}</h3>
            <div className="flex gap-4 mb-6 items-center">
                <div className="flex rounded-full w-2 h-2 bg-gray-400"></div>
                <div>{t("embeddedBrokerage.section4.pu1")}</div>
            </div>
            <div className="flex gap-4 mb-6 items-center">
                <div className="flex rounded-full w-2 h-2 bg-gray-400"></div>
                <div>{t("embeddedBrokerage.section4.pu2")}</div>
            </div>
            <p className="text-[16px] leading-7.5">{t("embeddedBrokerage.section4.p")}</p>
          </div>
      ...
      <section className="w-full my-15">
          <FlexWrapRight 
            SPAN={t("embeddedBrokerage.flexWrap.span")}
            H3={t("embeddedBrokerage.flexWrap.h3")}
            P={t("embeddedBrokerage.flexWrap.p")}
            Image="/gauche.svg"
            BLOCK={flexWrapBlock}
          />
      </section>
