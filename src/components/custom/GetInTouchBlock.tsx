...
export default function GetInTouchBlock() {
  const t = useI18n();
  return (
    <div className="w-full flex *:w-1/2 bg-black linear min-h-screen items-center mb-20 mt-10 px-8">
      <div className="pl-4">
        ...
        <p className="text-gray-200 mb-10 text-gray-400 w-[75%] mt-5">{t("GetInTouch.P")}</p>
        <button className="py-3 px-9 rounded-xl bg-white hover:cursor-pointer hover:bg-[#e9e7db]">
          {t("GetInTouch.B")}
        </button>
      </div>
      <section className="flex flex-col justify-center items-center gap-8 px-5 *:cursor-pointer ">
        <Card className="border border-[#3b3d40] rounded-xl p-1 bg-transparent w-[80%]">
