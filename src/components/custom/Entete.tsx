...
export default function Entete({SPAN, H3, P, BG, TEXT}: Entete) {
  return (
    ...
    <div className="container mxauto mb-5 w-full ">
      <span className={`py-1 px-4 rounded-2xl text-center max-w-max font-semibold text-sm ${BG} ${TEXT} `}>{SPAN}</span>
      <h3 className="text-4xl font-bold text-shadow-xl my-10">{H3}</h3>
